...
import { Upload, MapPin, CalendarDays, CloudLightning, X, FileDown } from 'lucide-react'
...
import SoilReportPDF   from './SoilReportPDF.jsx'
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in">
      ...
      <div className="hero-pattern bg-earth-800 rounded-3xl p-6 mb-8 relative overflow-hidden transition-all duration-500">
        <div className="relative z-10 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex gap-2 flex-wrap self-start sm:self-auto print:hidden">
            <Button
              variant="primary"
              className="bg-earth-500 hover:bg-earth-400"
            ...
            <Button
              variant="primary"
              className="bg-moss-600 hover:bg-moss-500"
