...
export const TRANSLATIONS = {
  ...
  en: {
    ...
    hero: { greeting:'Good morning, Farmer', location:'Survey 47/2, Nashik · Rabi 2025–26', upload:'Upload Report' },
    dashboard: {
    ...
    nutrients: { title:'Nutrient Profile', subtitle:'Macro & Micronutrients', macro:'Macronutrients', micro:'Micronutrients', optimal:'Optimal', deficient:'Deficient', excess:'Excess', barsTab:'Bars', trendTab:'Trend', trendTitle:'NPK Trend — Jun to Nov 2025' },
    ...
    community: {
      ...
      aiReplyBtn:'Ask Bhoomi Care', aiReplying:'Bhoomi Care is typing…',
      postTopic:'Topic', pinned:'Pinned',
      youLabel:'You',
      welcomeMsg:'Welcome to the Bhoomi Care Farmer Community! Chat with farmers from your region in your own language. Bhoomi Care can answer questions in any language.',
    },
  },
  ...
  hi: {
    ...
    hero:{ greeting:'नमस्ते, किसान भाई', location:'सर्वे नं. 47/2, नासिक · रबी 2025–26', upload:'रिपोर्ट अपलोड करें' },
    ...
    nutrients:{ title:'पोषक तत्व प्रोफाइल', subtitle:'वृहत् और सूक्ष्म पोषक', macro:'वृहत् पोषक तत्व', micro:'सूक्ष्म पोषक तत्व', optimal:'उचित', deficient:'कमी', excess:'अधिक', barsTab:'बार', trendTab:'प्रवृत्ति', trendTitle:'NPK प्रवृत्ति — जून से नवम्बर 2025' },
    ...
    community:{ title:'किसान समुदाय', subtitle:'अपने क्षेत्र के किसानों के साथ चैट करें', regionFilter:'क्षेत्र से फ़िल्टर', allRegions:'सभी क्षेत्र', myRegion:'मेरा क्षेत्र', online:'ऑनलाइन', chatPlaceholder:'किसी भी भाषा में संदेश लिखें…', sendBtn:'भेजें', joinRoom:'जुड़ें', leaveRoom:'छोड़ें', roomTitle:'क्षेत्रीय चैट', selectRegion:'चैट में जुड़ने के लिए अपना क्षेत्र चुनें', membersOnline:'किसान ऑनलाइन', translateBtn:'अनुवाद', aiReplyBtn:'Bhoomi Care से पूछें', aiReplying:'Bhoomi Care टाइप कर रहा है…', postTopic:'विषय', pinned:'पिन', youLabel:'आप', welcomeMsg:'Bhoomi Care किसान समुदाय में आपका स्वागत है! अपनी भाषा में अपने क्षेत्र के किसानों से बात करें।' },
  },
  ...
  ta: {
    ...
    nutrients:{ title:'சத்து சுயவிவரம்', subtitle:'மேக்ரோ & நுண் சத்துக்கள்', macro:'மேக்ரோ சத்துக்கள்', micro:'நுண் சத்துக்கள்', optimal:'சரியான அளவு', deficient:'குறைவு', excess:'அதிகம்', barsTab:'பட்டைகள்', trendTab:'போக்கு', trendTitle:'NPK போக்கு — ஜூன்–நவம்பர் 2025' },
    ...
    assistant:{ title:'AI மண் உதவியாளர்', subtitle:'மண், பயிர்கள், உரங்கள் பற்றி கேளுங்கள்', placeholder:'எந்த மொழியிலும் கேளுங்கள்…', sendBtn:'அனுப்பு', resetBtn:'மீட்டமை', poweredBy:'Google Gemini AI மூலம்', greeting:'வணக்கம் 🙏 நான் Bhoomi Care நிபுணர். மண்ணில் நைட்ரஜன் மற்றும் துத்தநாகம் குறைவு. உதவ தயாராக உள்ளேன்.', chips:['என் மண்ணிற்கு பயிர்?','நைட்ரஜன் சரிசெய்க','PM-KISAN தகுதி','கரிம கார்பன் அதிகரிக்க'], contextPills:{ n:'⬇ N: 38 கி.கி', p:'✓ P: சரி', zn:'⬇ Zn: குறைவு', ph:'✓ pH 6.8', field:'🌱 கணக்கெடுப்பு 47/2' } },
  ...
  te: {
    ...
    nutrients:{ title:'పోషక ప్రొఫైల్', subtitle:'స్థూల మరియు సూక్ష్మ పోషకాలు', macro:'స్థూల పోషకాలు', micro:'సూక్ష్మ పోషకాలు', optimal:'అనుకూలం', deficient:'లోపం', excess:'అధికం', barsTab:'బార్లు', trendTab:'ట్రెండ్', trendTitle:'NPK ట్రెండ్ — జూన్–నవంబర్ 2025' },
    ...
    assistant:{ title:'AI నేల సహాయకుడు', subtitle:'నేల, పంటలు, ఎరువుల గురించి అడగండి', placeholder:'ఏ భాషలోనైనా అడగండి…', sendBtn:'పంపండి', resetBtn:'రీసెట్', poweredBy:'Google Gemini AI ద్వారా', greeting:'నమస్కారం 🙏 నేను Bhoomi Care నిపుణుడిని. నేలలో నైట్రోజన్ మరియు జింక్ తక్కువ. సహాయపడతాను.', chips:['నా నేలకు పంట?','నైట్రోజన్ సరిచేయండి','PM-KISAN అర్హత','సేంద్రియ కార్బన్ పెంచండి'], contextPills:{ n:'⬇ N: 38 కి.గ్రా', p:'✓ P: అనుకూలం', zn:'⬇ Zn: లోపం', ph:'✓ pH 6.8', field:'🌱 సర్వే 47/2' } },
    ...
    community:{ title:'రైతు సమాజం', subtitle:'మీ జిల్లా రైతులతో నేరుగా చాట్', regionFilter:'జిల్లా ఫిల్టర్', allRegions:'అన్ని జిల్లాలు', myRegion:'నా జిల్లా', online:'ఆన్‌లైన్', chatPlaceholder:'ఏ భాషలోనైనా సందేశం పంపండి…', sendBtn:'పంపండి', joinRoom:'చేరండి', leaveRoom:'వదిలండి', roomTitle:'జిల్లా చాట్', selectRegion:'చాట్‌కు చేరడానికి జిల్లా ఎంచుకోండి', membersOnline:'రైతులు ఆన్‌లైన్', translateBtn:'అనువాదం', aiReplyBtn:'Bhoomi Care అడగండి', aiReplying:'Bhoomi Care టైప్ చేస్తోంది…', postTopic:'అంశం', pinned:'పిన్', youLabel:'మీరు', welcomeMsg:'Bhoomi Care రైతు సమాజంలో స్వాగతం! మీ భాషలో మాట్లాడండి.' },
  },
  ...
  bn: {
    ...
    nutrients:{ title:'পুষ্টি প্রোফাইল', subtitle:'স্থূল ও সূক্ষ্ম পুষ্টি', macro:'স্থূল পুষ্টি', micro:'সূক্ষ্ম পুষ্টি', optimal:'উপযুক্ত', deficient:'ঘাটতি', excess:'অতিরিক্ত', barsTab:'বার', trendTab:'প্রবণতা', trendTitle:'NPK প্রবণতা — জুন–নভেম্বর 2025' },
    ...
    assistant:{ title:'AI মাটি সহকারী', subtitle:'মাটি, ফসল, সার বা প্রকল্প সম্পর্কে জিজ্ঞাসা করুন', placeholder:'যেকোনো ভাষায় জিজ্ঞাসা করুন…', sendBtn:'পাঠান', resetBtn:'রিসেট', poweredBy:'Google Gemini AI দ্বারা', greeting:'নমস্কার 🙏 আমি Bhoomi Care বিশেষজ্ঞ। মাটিতে নাইট্রোজেন ও দস্তা কম। সাহায্য করব।', chips:['আমার মাটির জন্য ফসল?','নাইট্রোজেন সমাধান','PM-KISAN যোগ্যতা','জৈব কার্বন বাড়ান'], contextPills:{ n:'⬇ N: ৩৮ কেজি', p:'✓ P: উপযুক্ত', zn:'⬇ Zn: ঘাটতি', ph:'✓ pH ৬.৮', field:'🌱 জরিপ ৪৭/২' } },
    ...
    community:{ title:'কৃষক সম্প্রদায়', subtitle:'আপনার জেলার কৃষকদের সাথে সরাসরি চ্যাট', regionFilter:'জেলা ফিল্টার', allRegions:'সব জেলা', myRegion:'আমার জেলা', online:'অনলাইন', chatPlaceholder:'যেকোনো ভাষায় বার্তা লিখুন…', sendBtn:'পাঠান', joinRoom:'যোগ দিন', leaveRoom:'ছাড়ুন', roomTitle:'জেলা চ্যাট', selectRegion:'চ্যাটে যোগ দিতে জেলা নির্বাচন করুন', membersOnline:'কৃষক অনলাইন', translateBtn:'অনুবাদ', aiReplyBtn:'Bhoomi Care জিজ্ঞাসা', aiReplying:'Bhoomi Care টাইপ করছে…', postTopic:'বিষয়', pinned:'পিন', youLabel:'আপনি', welcomeMsg:'Bhoomi Care কৃষক সম্প্রদায়ে স্বাগতম! আপনার ভাষায় কথা বলুন।' },
  },
  ...
  mr: {
    ...
    nutrients:{ title:'पोषक प्रोफाइल', subtitle:'मॅक्रो आणि सूक्ष्म पोषक', macro:'मॅक्रो पोषक', micro:'सूक्ष्म पोषक', optimal:'योग्य', deficient:'कमतरता', excess:'जास्त', barsTab:'बार', trendTab:'ट्रेंड', trendTitle:'NPK ट्रेंड — जून–नोव्हेंबर 2025' },
    ...
    community:{ title:'शेतकरी समुदाय', subtitle:'तुमच्या जिल्ह्यातील शेतकऱ्यांशी थेट चॅट', regionFilter:'जिल्हा फिल्टर', allRegions:'सर्व जिल्हे', myRegion:'माझा जिल्हा', online:'ऑनलाइन', chatPlaceholder:'कोणत्याही भाषेत संदेश लिहा…', sendBtn:'पाठवा', joinRoom:'सामील व्हा', leaveRoom:'सोडा', roomTitle:'जिल्हा चॅट', selectRegion:'चॅटसाठी जिल्हा निवडा', membersOnline:'शेतकरी ऑनलाइन', translateBtn:'अनुवाद', aiReplyBtn:'Bhoomi Care विचारा', aiReplying:'Bhoomi Care टाइप करत आहे…', postTopic:'विषय', pinned:'पिन', youLabel:'तुम्ही', welcomeMsg:'Bhoomi Care शेतकरी समुदायात स्वागत! तुमच्या भाषेत बोला.' },
  },
  ...
  pa: {
    ...
    assistant:{ title:'AI ਮਿੱਟੀ ਸਹਾਇਕ', subtitle:'ਮਿੱਟੀ, ਫਸਲ, ਖਾਦ ਬਾਰੇ ਪੁੱਛੋ', placeholder:'ਕਿਸੇ ਵੀ ਭਾਸ਼ਾ ਵਿੱਚ ਪੁੱਛੋ…', sendBtn:'ਭੇਜੋ', resetBtn:'ਰੀਸੈੱਟ', poweredBy:'Google Gemini AI ਦੁਆਰਾ', greeting:'ਸਤਿ ਸ੍ਰੀ ਅਕਾਲ 🙏 ਮੈਂ Bhoomi Care ਮਾਹਰ ਹਾਂ। ਮਿੱਟੀ ਵਿੱਚ ਨਾਈਟ੍ਰੋਜਨ ਅਤੇ ਜ਼ਿੰਕ ਦੀ ਕਮੀ ਹੈ। ਮਦਦ ਕਰਾਂਗਾ।', chips:['ਮੇਰੀ ਮਿੱਟੀ ਲਈ ਫਸਲ?','ਨਾਈਟ੍ਰੋਜਨ ਸੁਧਾਰ','PM-KISAN ਯੋਗਤਾ','ਜੈਵਿਕ ਕਾਰਬਨ ਵਧਾਓ'], contextPills:{ n:'⬇ N: 38 ਕਿਗ੍ਰਾ', p:'✓ P: ਉਚਿਤ', zn:'⬇ Zn: ਕਮੀ', ph:'✓ pH 6.8', field:'🌱 ਸਰਵੇ 47/2' } },
    ...
    community:{ title:'ਕਿਸਾਨ ਭਾਈਚਾਰਾ', subtitle:'ਆਪਣੇ ਜ਼ਿਲ੍ਹੇ ਦੇ ਕਿਸਾਨਾਂ ਨਾਲ ਸਿੱਧਾ ਚੈਟ', regionFilter:'ਜ਼ਿਲ੍ਹਾ ਫਿਲਟਰ', allRegions:'ਸਭ ਜ਼ਿਲ੍ਹੇ', myRegion:'ਮੇਰਾ ਜ਼ਿਲ੍ਹਾ', online:'ਔਨਲਾਈਨ', chatPlaceholder:'ਕਿਸੇ ਵੀ ਭਾਸ਼ਾ ਵਿੱਚ ਸੁਨੇਹਾ ਲਿਖੋ…', sendBtn:'ਭੇਜੋ', joinRoom:'ਸ਼ਾਮਲ ਹੋਵੋ', leaveRoom:'ਛੱਡੋ', roomTitle:'ਜ਼ਿਲ੍ਹਾ ਚੈਟ', selectRegion:'ਚੈਟ ਲਈ ਜ਼ਿਲ੍ਹਾ ਚੁਣੋ', membersOnline:'ਕਿਸਾਨ ਔਨਲਾਈਨ', translateBtn:'ਅਨੁਵਾਦ', aiReplyBtn:'Bhoomi Care ਪੁੱਛੋ', aiReplying:'Bhoomi Care ਟਾਈਪ ਕਰ ਰਿਹਾ ਹੈ…', postTopic:'ਵਿਸ਼ਾ', pinned:'ਪਿੰਨ', youLabel:'ਤੁਸੀਂ', welcomeMsg:'Bhoomi Care ਕਿਸਾਨ ਭਾਈਚਾਰੇ ਵਿੱਚ ਸੁਆਗਤ ਹੈ!' },
  },
